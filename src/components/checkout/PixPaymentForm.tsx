...
export function PixPaymentForm({
  ...
  const { pixCode, expiresAt } = checkoutData;
    ...
    <div className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        <div className="flex gap-2">
          <div className="flex-1 bg-muted/50 border rounded-lg px-3 py-2.5 text-xs text-muted-foreground font-mono truncate select-all">
            {pixCode}
          </div>
          <Button
            type="button"
