...
const translations: Record<Locale, Record<string, string>> = {
  pt: {
    ...
    "block.customer.document": "CPF",
    "block.customer.documentPlaceholder": "000.000.000-00",
    "block.customer.documentRequired": "CPF é obrigatório",
    "block.customer.documentInvalid": "CPF inválido (11 dígitos)",
  ...
  en: {
    ...
    "block.customer.document": "CPF",
    "block.customer.documentPlaceholder": "000.000.000-00",
    "block.customer.documentRequired": "CPF is required",
    "block.customer.documentInvalid": "Invalid CPF (11 digits)",
  ...
  es: {
    ...
    "block.customer.document": "CPF",
    "block.customer.documentPlaceholder": "000.000.000-00",
    "block.customer.documentRequired": "CPF es obligatorio",
    "block.customer.documentInvalid": "CPF no válido (11 dígitos)",
  ...
  fr: {
    ...
    "block.customer.document": "CPF",
    "block.customer.documentPlaceholder": "000.000.000-00",
    "block.customer.documentRequired": "CPF est obligatoire",
    "block.customer.documentInvalid": "CPF invalide (11 chiffres)",
